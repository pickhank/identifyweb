...
<c:forEach var="cssStyle" items="${styles}">
	<link rel="stylesheet" type="text/css" href="http://open.mishua.cn${cssStyle}"></link>
</c:forEach>
</c:if>
<script>
...
<c:forEach var="js" items="${scripts}">
	<script type="text/javascript" src="http://open.mishua.cn${js}"></script>
</c:forEach>
</c:if>
</head>
	...
	<header>
		...
		<div id="menu-details" style="border-bottom: 2px solid #267ad2;">
			...
			<div class="weui-cells">
				...
				<a class="weui-cell weui-cell_access" href="<c:url value="/content/recon/index"/>">
					<div class="weui-cell__bd">
						<p>对账单</p>
					</div>
					<div class="weui-cell__ft">
				...
				<a class="weui-cell weui-cell_access" href="<c:url value="/content/downNoCardInvoice/index"/>">
					<div class="weui-cell__bd">
						<p>无卡交易</p>
					</div>
					<div class="weui-cell__ft">
				...
				<a class="weui-cell weui-cell_access" href="<c:url value="/content/downNoCardInvoice/sum"/>">
					<div class="weui-cell__bd">
						<p>无卡交易汇总</p>
					</div>
					<div class="weui-cell__ft">
			...
			<div class="weui-cells">
			<a class="weui-cell weui-cell_access" href="<c:url value="/content/systemUser/resetPassword"/>">
					<div class="weui-cell__bd">
						<p>修改密码</p>
					</div>
					<div class="weui-cell__ft">
