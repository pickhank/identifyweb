...
<div class="weui-flex exec-btn-wapper">
	...
	<div class="weui-flex__item">
		<form action="<c:url value="/admin/downNoCardInvoice/exportSum" />" target="_blank" method="post" class="export-form" style="display: inline;">
			<input type="submit" value="导出" class="weui-btn weui-btn_mini weui-btn_primary export-btn"></input>
		</form>
	</div>
</div>
<form class="search-form" action="<c:url value="/admin/downNoCardInvoice/sum" />" method="post" style="display:none;">
	...
	<div class="weui-form-preview">
		...
		<div class="weui-form-preview__bd">
			<div class="weui-form-preview__item">
				...
				<span class="weui-form-preview__value"><c:out value="${item.mchName}" /></span>
			</div>
			<div class="weui-form-preview__item">
			...
			<div class="weui-form-preview__item">
				<label class="weui-form-preview__label">机构利润</label>
				<span class="weui-form-preview__value"><c:out value="${item.profit}" /></span>
			</div>
			<div class="weui-form-preview__item">
				<label class="weui-form-preview__label">机构代付成本</label>
				<span class="weui-form-preview__value"><c:out value="${item.advanceFee}" /></span>
			</div>
			<div class="weui-form-preview__item">
				<label class="weui-form-preview__label">机构结算利润</label>
				<span class="weui-form-preview__value"><c:out value="${item.profit - item.advanceFee}" /></span>
			</div>
			<div class="weui-form-preview__item">
