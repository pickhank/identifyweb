...
<form class="search-form" action="<c:url value="/content/recon/index" />" method="post" style="padding-right:0px;">
	...
	<!--  a href="<c:url value="/content/recon/add" />" style="margin-right:10px;" class="btn btn-orange pull-right">对账</a>
	<a href="<c:url value="/content/recon/export" />"  style="margin-right:10px;" class="btn btn-orange pull-right">下载对账单</a>-->
</form>
