...
<script type="text/javascript" src="<%=resourceUrl%>/resources/m/js/common.js?3"></script>
...
<body unselectable="on" onselectstart="return false;">
	<header>
		...
		<div id="menu-details" style="border-bottom: 2px solid #267ad2;">
			...
			<div class="weui-cells__title">交易管理</div>
			<div class="weui-cells">
				<a class="weui-cell weui-cell_access" href="<c:url value="/admin/downNoCardInvoice/index"/>">
					<div class="weui-cell__bd">
						<p>快捷交易明细</p>
					</div>
					<div class="weui-cell__ft">
				...
				<a class="weui-cell weui-cell_access" href="<c:url value="/admin/downMerchantDeposit/index"/>">
					<div class="weui-cell__bd">
						<p>代付交易明细</p>
					</div>
					<div class="weui-cell__ft">
				...
				<a class="weui-cell weui-cell_access" href="<c:url value="/admin/downMerchant/index"/>">
					<div class="weui-cell__bd">
						<p>机构信息管理</p>
					</div>
					<div class="weui-cell__ft">
				...
				<a class="weui-cell weui-cell_access" href="<c:url value="/admin/downNoCardRoute/index"/>">
					<div class="weui-cell__bd">
						<p>机构交易路由</p>
					</div>
					<div class="weui-cell__ft">
