...
<form class="search-form" action="<c:url value="/agent/downMerchantBalance/index" />" method="post" style="min-height: 30px;">
...
<form action="<c:url value="/agent/downMerchantBalance/export" />" target="_blank" method="post" class="export-form">
