...
<form class="search-form" style="padding-right: 88px; box-sizing: border-box;" target="_blank" action="<c:url value="/admin/recon/export" />" method="post">
	...
	<a href="<c:url value="/admin/recon/index" />" class="btn btn-orange pull-right">返回列表</a>
</form>