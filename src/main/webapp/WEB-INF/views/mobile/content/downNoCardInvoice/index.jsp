...
<div class="weui-flex exec-btn-wapper">
	...
	<div class="weui-flex__item">
		<form action="<c:url value="/content/downNoCardInvoice/export" />" target="_blank" method="post" class="export-form" style="display: inline;">
			<input type="submit" value="导出" class="weui-btn weui-btn_mini weui-btn_primary export-btn"></input>
		</form>
	</div>
</div>
<form class="search-form" action="<c:url value="/content/downNoCardInvoice/index" />" method="post" style="display:none;">
...
<utils:mobilepager/>
	...
	<div class="weui-form-preview__ft">
		<a class="weui-form-preview__btn weui-form-preview__btn_primary operate-detail" href="<c:url value="/content/downNoCardInvoice/add?id=${item.id}" />">详情</a>
	</div>
	</div>
	<br>
	</c:forEach>