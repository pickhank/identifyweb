 ...
 */
@Controller
@RequestMapping("/content/systemUser")
public class ContentSystemUserController extends BaseController {
	private static Logger log = Logger.getLogger(ContentSystemUserController.class);
	...
	public ModelAndView resetPassword(SystemUserViewData resetData) {
		...
		ModelAndView mav = new ModelAndView(getTemplate("/content/systemUser/resetPassword"));
		return mav;
	}
