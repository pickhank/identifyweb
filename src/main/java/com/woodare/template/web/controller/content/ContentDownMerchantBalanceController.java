...
/**
 * ClassName: ContentDownMerchantBalanceController
 * 
 * @description
 * @author Luke
 * @Date Mar 4,2018
 */
@Controller
@RequestMapping("/content/downMerchantBalance")
public class ContentDownMerchantBalanceController extends BaseController {
	...
	public ModelAndView index(SearchDownMerchantBalanceViewData searchData) throws ControllerException {
		return showIndex(getTemplate("/content/downMerchantBalance/index"), searchData, null);
	}
	...
	public ModelAndView add(DownMerchantBalanceViewData data) throws ControllerException {
		ModelAndView mav = new ModelAndView(getTemplate("/content/downMerchantBalance/details"));
