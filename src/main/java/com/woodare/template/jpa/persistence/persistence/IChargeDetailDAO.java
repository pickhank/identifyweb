 ...
 *
 */
public interface IChargeDetailDAO extends ISimpleDAO<ChargeDetail> {

	IPagedList<ChargeDetail> searchItems(SearchChargeDetailData searchData);

	ChargeDetail findById(String id);
