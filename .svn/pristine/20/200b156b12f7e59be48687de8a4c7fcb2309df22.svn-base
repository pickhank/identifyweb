 ...
 * @author Luke
 */
public interface IDspCardPassway {
	 ...
	 * @throws AbstractWooException
	 */
	PasswayDspResponseData processC112(PasswayDspRequestData reqData) throws AbstractWooException;
	 ...
	 * @throws AbstractWooException
	 */
	PasswayDspResponseData processC115(PasswayDspRequestData reqData) throws AbstractWooException;
	 ...
	 * @throws AbstractWooException
	 */
	PasswayDspResponseData processC116(PasswayDspRequestData reqData) throws AbstractWooException;
	 ...
	 * @throws AbstractWooException
	 */
	PasswayDspResponseData processC123(PasswayDspRequestData reqData) throws AbstractWooException;
}
