...
<div class="weui-flex exec-btn-wapper">
	...
	<div class="weui-flex__item"><a href="<c:url value="/admin/agent/add" />" class="weui-btn weui-btn_mini weui-btn_warn operate-detail">新建</a></div>
</div>
<form class="search-form" action="<c:url value="/admin/agent/index" />" method="post" style="display:none;">
...
<utils:mobilepager/>
	...
	<div class="weui-form-preview">
		...
		<div class="weui-form-preview__ft">
			<a class="weui-form-preview__btn weui-form-preview__btn_primary operate-detail" href="<c:url value="/admin/agent/add?id=${item.id}" />">编辑</a>
		</div>
	</div>
	<br>
	</c:forEach>