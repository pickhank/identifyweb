...
<form class="search-form" style="padding-right: 88px; box-sizing: border-box;" target="_blank" action="<c:url value="/agent/recon/export" />" method="post">
	...
	<a href="<c:url value="/agent/recon/index" />" class="btn btn-orange pull-right">返回列表</a>
</form>